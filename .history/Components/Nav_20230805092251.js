...
function Nav() {
  ...
  return (
    <div className='flex justify-between sticky top-0 items-center border-b border-[#ccc] px-3 py-5 z-50'>
        ...
        {username ? <TopBanner /> : <div className='hidden lg:flex items-center text-lg cursor-pointer'>
