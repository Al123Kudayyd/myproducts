    ...
    <div>
        <div className='mt-24'>
            ...
            <div className='flex justify-center'>
              <button className='bg-[#1cc592] px-10 py-4 my-7 text-white font-bold text-xl hover:bg-white hover:border-[#1cc592]
              hover:text-[#1cc592] durat'>Write a review!</button>
            </div>
        </div>
    </div>
  )
