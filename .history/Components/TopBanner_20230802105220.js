...
function TopBanner() {
  ...
  return (
    <div className='hidden lg:flex items-center text-lg cursor-pointer'>
          ...
          {modal && <div className='shadow-xl absolute top-[100px] rounded-md px-8 py-3 right-0 text-gray-500'>
                <div className='py-2 flex items-center hover:bg-gray-200 w-full'>
                    <MdOutlineSell />
