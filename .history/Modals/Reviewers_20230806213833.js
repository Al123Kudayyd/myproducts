    ...
    <div>
        ...
        className='flex justify-center mt-24'>
            <div className='w-[350px] h-[500px] bg-white relative'>
                <RxCross2 className='text-3xl text-gray-800 cursor-pointer' onClick={() => dispatch(closeReviewModal())} />
                <div className='flex flex-col items-center justify-center relative'>
                    ...
                    <button className='bg-[#1cc592] px-5 py-3 hover:bg-opacity-50 transition 
                        duration-300 rounded-md text-xl font-bold w-full mt-5'>Submit</button>
                </div>
            </div>
        </Modal>
    </div>
