          ...
          <div className=''>
            ...
            <div className='flex flex-col items-center'>
              <input 
                type={"email"}
                placeholder='Email' 
                className='h-5 rounded-md bg-transparent border border-gray-700 p-3 rounded-fu mb-5'
                onChange={e => setEmail(e.target.value)} 
              />
              <input 
                type={"password"}
                placeholder='Password' 
                className='h-5 rounded-md bg-transparent border border-gray-700 p-3 rounded-fu spac'
