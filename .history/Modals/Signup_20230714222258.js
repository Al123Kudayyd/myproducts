          ...
          <div className=''>
            ...
            <div className='flex flex-col items-center'>
              <input 
                type={"email"}
                placeholder='Email' 
                className='h-5 rounded-md bg-transparent border border-gray-700 p-3 rounded-lg mb-5'
                onChange={e => setEmail(e.target.value)} 
              />
              <input 
                type={"password"}
                placeholder='Password' 
                className='h-5 rounded-md bg-transparent border border-gray-700 p-3 rounded-lg spac'
                onChange={e => setPassword(e.target.value)}
              />
              <h2 className='text-[#1cc592] font-medium text-xl my-5 cursor-pointer'>Don't have an account? Sign Up</h2>
              <button className="bg-[#1cc592] text-white w-full rounded-full
              font-bold text-xl px-5 py-4 ">Sign In</button>
            </div>
