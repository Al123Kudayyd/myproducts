        ...
        className='bg-black flex justify-center'>
          <div className=''>
            ...
            <div className='flex flex-col items-center'>
              ...
              {loading ? <button className="bg-[#1cc592] animate-spin text-white w-full rounded-full
              font-bold text-xl px-5 py-4 flex justify-center"><AiOutlineLoading /></button> :
              <button className="bg-[#1cc592] text-white w-full rounded-full
              font-bold text-xl px-5 py-4 hover:opacity-50"
